...
> 更新時間：2026-08-07 03:32 UTC  
> 其他已成功指標仍會在背景抓取、接受來源修訂並更新Cache，只是不顯示於本表。

| 指標 | 最新資料月份 | 來源 | 抓取方式 | 官方序列／定義 | 2026/08/31 | 2026/06/30 | 2026/05/31 | 2026/04/30 | 2026/03/31 |
|---|---:|---|---|---|---:|---:|---:|---:|---:|
...
| 零售控制 | 2026/06/30 | U.S. Census Bureau | API＋計算（Census MARTS） | 44X72 - (4411,4412) - 447 - 444 - 722; seasonally adjusted monthly sales MoM% | N/A | 0.551 | 0.865 | 0.559 | 0.955 |
| 家戶金融狀況vs一年前 | 2026/06/30 | University of Michigan | XLS（Michigan官方圖表下載） | PAGO_R_M (monthly data) | N/A | 63 | 58 | 67 | 74 |
| 預計未來一年金融狀況 | 2026/06/30 | University of Michigan | XLS（Michigan官方圖表下載） | PEXP_R_ALL | N/A | 79 | 79 | 86 | 91 |
...
- Census retail control: Census MARTS missing control-group components: auto_other_motor_vehicles
